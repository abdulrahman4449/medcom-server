...
export * from ${JSON.stringify(ROOT + "src/domain/desk-duty.jsx")};
export * from ${JSON.stringify(ROOT + "src/domain/schedule.jsx")};
...
export { toneKeyFor, alarmLoudnessNote, shellBuildNote, volumeFloorNote, SHELL_BUILD_WANTED } from ${JSON.stringify(ROOT + "src/lib/dates.jsx")};
